...
RSpec.describe "Dashboard" do
  it "US3: has names of the top 5 customers with the count of their successful transactions" do
    ...
    @transaction1 = @invoice1.transactions.create(credit_card_number: 1234, credit_card_expiration_date: 01/11, result: 1, invoice_id: @invoice1.id)
    @transaction2 = @invoice2.transactions.create(credit_card_number: 1234, credit_card_expiration_date: 01/11, result: 1, invoice_id: @invoice2.id)
    @transaction3 = @invoice3.transactions.create(credit_card_number: 1234, credit_card_expiration_date: 01/11, result: 1, invoice_id: @invoice3.id)
    @transaction4 = @invoice4.transactions.create(credit_card_number: 1234, credit_card_expiration_date: 01/11, result: 1, invoice_id: @invoice4.id)
    @transaction5 = @invoice5.transactions.create(credit_card_number: 1234, credit_card_expiration_date: 01/11, result: 1, invoice_id: @invoice5.id)
    @transaction6 = @invoice6.transactions.create(credit_card_number: 1234, credit_card_expiration_date: 01/11, result: 1, invoice_id: @invoice6.id)
